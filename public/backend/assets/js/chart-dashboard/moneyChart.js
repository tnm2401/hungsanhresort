$(function() {
    var charts = {
        ...
        ajaxGetDialyGuestPerMonthData: function() {
            var urlPath = 'administrator/get-money-chart-data';
            var request = $.ajax({
                method: 'GET',
                url: urlPath
            });
        ...
        createGuestsChart: function(response) {
            ...
            var visitorsChart = $('#money-chart')
            var this_year = $('#money-chart').attr('this-year')
            var this_month = $('#money-chart').attr('this-month')
            var visitorsChart = $('#money-chart')
            var myVisitorChart = new Chart(visitorsChart, {
                data: {
                    ...
                    datasets: [{
                            type: 'line',
                            data: response.money_count_data,
            ...
            // var visitorsChart = document.getElementById("money-chart");

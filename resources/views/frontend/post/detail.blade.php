...
@section('content')
  <!--Page Title-->
  <div style="margin-top:75px" class="page section-header text-center mb-0">
    <div class="page-title">
        <div class="wrapper">
            <h1 class="page-width">{{ $post->translations->name }}</h1>
        </div>
    </div>
</div>
<!--End Page Title-->
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-9 col-lg-9 main-col">
            <div class="blog--list-view">
                <div class="article">
                    <!-- Article Image -->
                    <a class="article_featured-image" href="#"><img class="blur-up lazyload" data-src="{{asset('frontend')}}/assets/images/blog/blog-post-1.jpg" src="{{asset('frontend')}}/assets/images/blog/blog-post-1.jpg" alt="It's all about how you wear"></a>

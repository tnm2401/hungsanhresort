...
@section('content')
    <!--MainContent-->
    <div style="margin-top:75px" id="MainContent" class="main-content" role="main">
        <!--Breadcrumb-->
        <div class="bredcrumbWrap">
            <div class="container breadcrumbs">
                <a href="{{ url('/') }}" title="Back to the home page">Home</a><span
                    aria-hidden="true">›</span><span>{{ $product->translations->name }}</span>
            </div>
        </div>
        <!--End Breadcrumb-->
        ...
        <div id="ProductSection-product-template" class="product-template__container prstyle1 container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-details-img">
                            <div class="product-thumb">
                                <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                    @foreach ($product->images as $img)
                                        <a data-image="{{ asset('storage') }}/uploads/products/{{ $img->imgs }}"
                                            data-zoom-image="{{ asset('storage') }}/uploads/products/{{ $img->imgs }}"
                                            class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true"
                                            tabindex="-1">
                                            <img class="blur-up lazyload"
                                                src="{{ asset('storage') }}/uploads/products/{{ $img->imgs }}"
                            ...
                            <div class="lightboximages">
                                @foreach ($product->images as $img)
                                <a href="{{ asset('storage') }}/uploads/products/{{ $img->imgs }}"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-single__meta">
                            <h1 class="product-single__title">{{ $product->translations->name }}</h1>
                            ...
                            <div class="prInfoRow">
                                ...
                                <div class="product-sku">SKU: <span class="variant-sku">{{ $product->product_code }}</span></div>
                            ...
                            <p class="product-single__price product-single__price-product-template">
                                ...
                                <s id="ComparePrice-product-template"><span class="money">{{ number_format($product->price) }} đ</span></s>
                                <span
                                    class="product-price__price product-price__price-product-template product-price__sale product-price__sale--single">
                                    <span id="ProductPrice-product-template"><span
                                            class="money">{{ number_format($product->selling_price) }} đ</span></span>
                                </span>
                                <span class="discount-badge"> <span class="devider">|</span>&nbsp;
                                    <span>You Save</span>
                                    <span id="SaveAmount-product-template" class="product-single__save-amount">
                                        <span class="money">{{ number_format($product->price - $product->selling_price )}} đ</span>
                                    </span>
                                ...
                                <span
                                    class="product-price__price product-price__price-product-template product-price__sale product-price__sale--single">
                                    <span id="ProductPrice-product-template"><span
                                            class="money">{{ number_format($product->price) }} đ</span></span>
                                </span>
                        ...
                        <form method="post" action="{{ route('order.now.quantity') }}" id="product_form_10508262282"
                            ...
                            <p class="infolinks"><a href="#sizechart" class="sizelink btn"> Size
                                    Guide</a> <a href="#productInquiry" class="emaillink btn"> Ask About this
                                    Product</a></p>
                            <!-- Product Action -->
                            <div class="product-action clearfix">
                                <div class="product-form__item--quantity">
                                    <div class="wrapQtyBtn">
                                        <div class="qtyField">
                                            ...
                                            <input type="text" id="qty" {{-- id="Quantity" --}} {{-- name="quantity" --}} name="qty" value="1"
                                ...
                                <div class="product-form__item--submit">
                                    <button type="submit" name="add buy_add_to_cart" class="btn product-form__cart-submit">
            ...
            <div class="prFeatures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                        <img src="{{ asset('frontend') }}/assets/images/worldwide.png" alt="Worldwide Delivery"
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                ...
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image5-1.jpg"
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image6.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image6.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image6-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image6-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                                <!-- product label -->
                                <div class="product-labels rectangular"><span class="lbl on-sale">-16%</span> <span
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image7.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image7.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image7-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image7-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image8.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image8.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image8-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image8-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image9.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image9.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image9-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image9-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image10.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image10.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image10-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image10-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image13.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image13.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image13-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image13-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image14.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image14.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image14-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image14-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                <!-- image -->
                                <img class="primary blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image15.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image15.jpg"
                                    alt="image" title="product">
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload"
                                    data-src="{{ asset('frontend') }}/assets/images/product-images/product-image15-1.jpg"
                                    src="{{ asset('frontend') }}/assets/images/product-images/product-image15-1.jpg"
                                    alt="image" title="product">
                                <!-- End hover image -->
                            </a>
                            <!-- end product image -->

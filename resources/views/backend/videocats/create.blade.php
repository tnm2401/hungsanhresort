...
@section('title','Thêm danh mục video')
@push('script')
...
@section('content')
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            @endif
            <form method="POST" action="{{ route('backend.videocat.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <button class="btn btn-primary"><i class="fa fa-save"></i> Lưu</button>
                                <a href="{{ route('backend.videocat.index') }}" class="btn btn-danger"><i
                                        class="fa fa-times-circle"></i> Thoát</a>
                            </div>
                        </div>
                        <div class="box box-primary">

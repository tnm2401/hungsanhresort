...
@section('title','Quản lí danh mục bài viết cấp 1')
@section('content')
            ...
            <table id="newcatones" class="table table-bordered table-striped set__width">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('backend.newcatone.edit', $newcatone->id) }}"><img src="{{ asset('storage') }}/uploads/newcatone/{{ $newcatone->img }}" class="img-thumbnail" style="max-width: 60px;margin-bottom: 0px">
                    </a>
                  </td>
                  <td><strong><a href="{{ route('backend.newcatone.edit', $newcatone->id) }}">{{ $newcatone->translations->name ?? ''}}</a></strong></td>
                  <td>
                  ...
                  <td>
                    ...
                    <form method="POST" action="{{ route('backend.newcatone.destroy', $newcatone->id) }}" style="display: inline;">
                      @csrf
                      {{ method_field('DELETE') }}

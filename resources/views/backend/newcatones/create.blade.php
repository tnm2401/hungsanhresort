...
@section('title','Thêm danh mục bài viết cấp 1')
@push('script')
...
<div class="content-wrapper" id="pjax-container">
  ...
  <section class="content">
    ...
    @endif
    <form method="POST" action="{{ route('backend.newcatone.store') }}" enctype="multipart/form-data">
      @csrf
      <div class="row">
        <!-- left column -->
        <div class="col-md-9">
                  ...
                  <div class="tab-pane {{$loop->first ? 'in active' : ''}} tab-content-en" id="tab_{{$lang->locale}}">
                          <div class="form-group">
                              ...
                              <input type="text" name="translation[{{$key}}][name]" id="name_{{ $lang->locale }}" onkeyup="AutoSlug();"
                                  value="{{ old('translation['.$key.'][name]') }}" class="form-control" data-toggle="tooltip"
                                  data-placement="top" title="Nhập tên danh mục">
                          </div>
                          <div class="form-group">
                              ...
                              <textarea class="form-control" name="translation[{{$key}}][descriptions]" id="descriptions_{{ $lang->locale }}"
                                  ...
                                  data-placement="top" title="Nhập mô tả danh mục"></textarea>
                          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input type="file" name="img" class="form-control" data-toggle="tooltip" data-placement="top" title="Dimensions min 370 x 250 (px)">
              </div>
            </div>
          </div>
          <div class="box box-primary">

    ...
    @foreach ($language as $lang)
        <script>
            ...
            $(document).on('change', 'input#name_{{ $lang->locale }}', function() {
                ...
                $('div#slug{{ $lang->locale }}').text(window.location.hostname + '/tuyen-dung/' + slug1 + '.html');
            });
...
@section('content')
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            @endif
            <form id="stringLengthForm" method="POST" action="{{ route('backend.recruitment.store') }}"
                                    ...
                                    <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en"
                                        id="tab_{{ $lang->locale }}">
                                                <div class="form-group">
                                                    <label>Tên tin ({{ $lang->locale }})</label>
                                            ...
                                            <div class="box-header with-border">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                        ...
                                                        id="keywords_{{ $lang->locale }}" data-length=400
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                        ...
                                                        id="des_{{ $lang->locale }}" data-length=400
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <input type="number" name="quantity" min="1" id="quantity"
                                        value="{{ old('quantity') }}" class="form-control" data-toggle="tooltip"
                                        data-placement="top" title="Nhập số lượng cần tuyển">
                                </div>
                            </div>
                        </div>
                        <div class="box box-primary">

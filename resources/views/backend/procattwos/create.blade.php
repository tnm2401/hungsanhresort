...
@section('content')
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            <form method="POST" action="{{ route('backend.procattwo.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{$loop->first ? 'in active' : ''}} tab-content-en" id="tab_{{$lang->locale}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="infomation"
                                                    rows="3">{!! old('infomation') !!}</textarea>
                                            </div>
                                            @endif

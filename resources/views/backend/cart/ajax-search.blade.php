...
@section('title')
    Quản lí hóa đơn từ {{ \Carbon\Carbon::parse($from)->toDateString() }} đến {{ \Carbon\Carbon::parse($to)->toDateString() }}
@endsection
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    onclick="return confirm('Xác nhận Xóa ?')" style="display: inline;">
                                                    @csrf
                                                    {{ method_field('DELETE') }}

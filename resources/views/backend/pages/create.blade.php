...
@section('content')
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            @endif
            <form id="stringLengthForm" method="POST" action="{{ route('backend.page.store') }}"
                    ...
                    <div class="col-md-9">
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="tab-pane {{ $loop->first ? 'in active' : '' }} tab-content-en"
                                        id="tab_{{ $lang->locale }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="translation[{{ $key }}][descriptions]" id="descriptions_{{ $lang->locale }}" cols="30" rows="10"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="box-header with-border">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" type="text"
                                                        ...
                                                        data-toggle="tooltip" data-placement="top" title="Nhập Url trang">
                                                </div>
                                                <div class="form-group">
                                                    <label>Title</label>
                                ...
                                <a href="{{ route('backend.page.index') }}" class="btn btn-danger"><i

...
@foreach($language as $lang)
    ...
    <script>
        $('document').ready(function() {
            ...
            $("#title_{{ $lang->locale }}").keyup(function() {
                $("#title{{ $lang->locale }}").text(this.value);
            });
            ...
            $(document).on('change', 'input#name_{{ $lang->locale }}', function() {
                ...
                $('div#slug{{ $lang->locale }}').text(window.location.hostname + '/tags/' + slug{{ $lang->locale }} + '.html');
            });
...
@section('content')
    ...
    <div class="content-wrapper" id="pjax-container">
        ...
        <section class="content">
            ...
            @endif
            <form method="POST" action="{{ route('backend.tag.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-9">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{$loop->first ? 'in active' : ''}} tab-content-en" id="tab_{{$lang->locale}}">
                                        <div class="form-group">
                                            <label>Tên Tag ({{ $lang->locale }})</label>
                                            <input type="text" name="translation[{{$key}}][name]" id="name_{{ $lang->locale }}" onkeyup="AutoSlug();"
                                                ...
                                                data-placement="top" title="Nhập tên Tag">
                                        </div>
                                        @if($loop->first)
                                        <div class="form-group">
                                            <label>Loại</label>
                                        ...
                                        @endif
                                        <div class="form-group">
                                            <label>Mô tả Tag ({{ $lang->locale }})</label>
                                            <textarea class="form-control" name="translation[{{$key}}][descriptions]" id="descriptions_{{ $lang->locale }}"
                                                value="{{ old('descriptions_'.$lang->locale) }}" rows="3" data-toggle="tooltip"
                                                data-placement="top" title="Nhập mô tả Tag"></textarea>
                                        </div>
                                    <div class="box-header with-border">
                                        ...
                                        <div class="form-group">
                                            <label>URL Tag ({{ $lang->locale }})</label>
                                            <input type="text" type="text" name="translation[{{$key}}][slug]" id="slug_{{ $lang->locale }}"
                                                ...
                                                data-placement="top" title="Nhập URL Tag">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="translation[{{$key}}][title]" id="title_{{ $lang->locale }}"
                                                ...
                                                data-toggle="tooltip" data-placement="top" title="Nhập tiêu đề Tag">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="translation[{{$key}}][keywords]" id="keywords_{{ $lang->locale }}"
                                                ...
                                                data-placement="top" title="Nhập từ khoá cho Tag"></textarea>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="translation[{{$key}}][description]" id="des_{{ $lang->locale }}"
                                                ...
                                                data-placement="top" title="Nhập mô tả ngắn Tag"></textarea>
                                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <button class="btn btn-primary"><i class="fa fa-save"></i> Lưu</button>
                                <a href="{{ route('backend.tag.index') }}" class="btn btn-danger"><i
                                        class="fa fa-times-circle"></i> Thoát</a>
                            </div>
                        </div>
                        <div class="box box-primary">
